%% Sub-Microthruster Fusion Technique Simulation: Thrust Vector Tolerancing
...
az_tol = 0.001*1; % Error in thruster force vector in the xy plane
dec_tol = 0.001*1; % Error in thruster force vector about the z-plane
...
thrust_vec_arr(:,kk) = thrust_vec_unit;
...
save('Spacecraft_outKF_Full_Sim_Vector_Uncert')