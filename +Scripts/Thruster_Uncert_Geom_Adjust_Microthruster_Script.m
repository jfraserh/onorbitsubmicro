%% Sub-Microthruster Fusion Technique Simulation: Geometry Tolerancing
...
mech_tol = 1;
geom_set = zeros([3 100]);
for kk = 1:100

% Set spacecraft tolerancing values
sc_tol = 1/1000*1;% spacecraft +/- tolerance in m
...
thrust_tol = 1/1000*0;% thruster loc +/- tolerance in m
...
control_thrust_EKF = 0.1903; % baseline measurement in micronewtons
control_thrust_UKF = 0.1922; % baseline measurement in micronewtons

% save('ADD_outKF_Full_Sim_SG')
% load Spacecraft_outKF_Full_Sim_Geom_Uncert.mat
...
save('Spacecraft_outKF_Full_Sim_Geom_Uncert')